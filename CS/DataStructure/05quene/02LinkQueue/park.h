...
/*
void park::read(istream& in)
{

}


istream& operator >>(istream& in, park& x)
{
    x.read(in);
    return in;
}
...
/*
void park::parkStack::display(ostream& out) const
{

}

ostream& operator <<(ostream& out, const park::parkStack& x)
{
    x.display(out);
    return out;
}
...
/*
void park::parkStack::read(istream& in)
{

}


istream& operator >>(istream& in, park::parkStack& x)
{
    x.read(in);
    return in;
}
*/
/*
void park::parkQueue::display(ostream& out) const
{
    int n = 0;
    typename parkQueue::nodeP tmp = this->front;
    if(tmp == this->rear)
    {
        out << "    front/rear→" << tmp->data << endl; 
    }
    else
    {
        while(tmp != this->rear)
...
ostream& operator <<(ostream& out, const park::parkQueue& x)
{
    x.display(out);
    return out;
}
...
/*
void park::parkQueue::read(istream& in)
{

}


istream& operator >>(istream& in, park::parkQueue& x)
{
    x.read(in);
    return in;
}
